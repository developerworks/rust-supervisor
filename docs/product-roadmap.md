...
> 最后更新: 2026-05-19 | 当前版本: 0.1.2 | 目标版本: 1.0.0
...
| 切片  | 功能                                        | 状态       | 依赖                | 说明                                                                 |
| ----- | ------------------------------------------- | ---------- | ------------------- | -------------------------------------------------------------------- |
| 006-7 | Chaos & Soak Testing(混沌与浸泡测试)        | **已实现** | 006-3, 006-4, 006-5 | 11 种混沌故障波形 + SC 阈值表, 24h 浸泡 + SoakReport                 |
...
- [x] 006-7: Chaos & Soak — 11 种混沌场景、24h 浸泡测试、报表自动化
