...
- [ ] No lossy conversions from binary floating JSON numbers into integers
- [ ] `Decimal` used for money/precision-sensitive values, not binary floating primitives
...
- Lossy numeric conversions (binary floating precision loss for monetary values)
